...
EXCEL_PATH = OUTPUT_DIR / "matched_nonlinearity_transform_mismatch_quantile_n2000_p50_a10.xlsx"
...
def fit_ann(X_train, X_test, y_train, y_test, seed, output_distribution):
    pipeline = Pipeline([
...
def fit_ann_qnormal(X_train, X_test, y_train, y_test, seed):
    return fit_ann(X_train, X_test, y_train, y_test, seed, "normal")


def fit_ann_quniform(X_train, X_test, y_train, y_test, seed):
    return fit_ann(X_train, X_test, y_train, y_test, seed, "uniform")


MODEL_FITTERS = {"ann_qnormal": fit_ann_qnormal, "ann_quniform": fit_ann_quniform}
